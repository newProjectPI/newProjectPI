...
<body>
	...
	<div class="header" id="home1">
		<div class="container">
			<div class="w3l_login">
				<a href="#" data-toggle="modal" data-target="#myModal88"><img src="images/logo.png" width="80" height="80"></a>
			</div>
			<div class="w3l_logo">
	...
	<!-- slide show -->
	<div >
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="width: 100%;" data-interval="3000">
			<!-- Indicators -->
			...
			<div class="carousel-inner" role="listbox">
				<div class="item">
					<img src="laptop/acer/dell.jpg" alt=""  style="margin-left: auto; margin-right:auto; width: 100%;height: 100%">
					<div class="carousel-caption">
						<!-- 	title -->
					</div>
				</div>
				<div class="item">
					<img src="laptop/acer/microsoft.jpg" alt=""  style="margin-left: auto; margin-right:auto; width: 100%;height: 100%" >
					<div class="carousel-caption">
						<!-- 	title -->
					</div>
				</div>
				<div class="item active">
					<img src="laptop/acer/acer-aspire.jpg" alt=""  style="margin-left: auto; margin-right:auto;width: 100%;height: 100%">
					<div class="carousel-caption">
						<!-- 	title -->
					</div>
				</div>
	...
	<div id="showtext" style="width:100%; height: 40px; font-size: 25px; ">
		<marquee>សូមស្វាគមន៏មកកាន់គេហទំព័ររបស់យើងខ្ញុំ លោកអ្នកអាចធ្វើការទំនាក់ទំនងដើម្បីផ្សពផ្សាយពានិជ្ជកម្មក្នុងតម្លៃសម្រម។ </marquee>
	</div>
	<!-- //banner --> 
	<!-- banner-bottom -->
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="Asus/Asus4.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
							<h4>The Best Computer</h4>
							<p>ASUS ROG G752VS (2017)
								- Intel i7-6820HK (2.70GHz) <br>
								- RAM: 16GB DDR4 (Speed 2133 MHz) <br>
								- HDD : 1TB + 512GB PCIe <br>
								- Optical Drive: DVD-RW <br>
								- VGA 1 : Intel HD Graphics 530 <br>
								- VGA 2 : NVIDIA GTX 1070 (8GB) <br>
								- Gigabit Ethernet, Bluetooth 4.1 <br>
								- Battery: 8 Cell 88 Wh 6000 mAh <br>
								- Weight : 3.5 Kg <br>
								- Windows 10 License </p>
							<div class="rating">
		...
		<div class="container">
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_left">
					...
					<div>
						<img src="images/Alienware-14-17-18-family-shot.jpg">
					</div>
				</div>
	...
	<!-- <div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>&copy; 2017 Panda Shop. All rights reserved | Design by <a href="http://Panda_Shop/">Panda Developer</a></p>
			</div>
		</div>
	</div>
	<!-- //footer --> 
